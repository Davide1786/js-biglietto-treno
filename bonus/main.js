...
if (eta < 18) {
   ...
   document.getElementById('PrezzoBiglietto').innerHTML = 'Il prezzo del biglietto è di € ' + underPrezzoBiglietto.toFixed(2);
} else if (eta >= 65) {
   var overPrezzoBiglietto = prezzoKilometri * chilometri * 0.8;
   document.getElementById('PrezzoBiglietto').innerHTML = 'Il prezzo del biglietto è di € ' + overPrezzoBiglietto.toFixed(2);
} else {
   var totPrezzoBiglietto = prezzoKilometri * chilometri;
   document.getElementById('PrezzoBiglietto').innerHTML = 'Il prezzo del biglietto è di € ' + totPrezzoBiglietto.toFixed(2);
}
